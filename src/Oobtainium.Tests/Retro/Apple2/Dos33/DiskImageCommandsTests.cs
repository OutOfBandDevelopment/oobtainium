...
using OoBDev.Oobtainium.Retro.Apple2.Dos33;
using OoBDev.Oobtainium.TestUtilities;
using System;
using System.Linq;

namespace OoBDev.Oobtainium.Tests.Retro.Apple2.Dos33;
...
public class DiskImageCommandsTests
{
    ...
    public void GetTrackSectorListForFileEntryTest()
    {
        ...
        {
            TestContext.WriteLine($"{tsl.NextTrack}/{tsl.NextSector}: {tsl.SectorOffset}");
