...
public static partial class ReadOnlySpanEx
{
    ...
    public static void CopyToWithTransform<TIn, TOut>(this ReadOnlySpan<TIn> input, Span<TOut> target, Func<TIn, TOut> transform)
    {
        ...
        {
            case 7:
                target[6] = transform(input[6]);
                goto case 6;
            case 6:
                target[5] = transform(input[5]);
                goto case 5;
            case 5:
                target[4] = transform(input[4]);
                goto case 4;
            case 4:
                target[3] = transform(input[3]);
                goto case 3;
            case 3:
                target[2] = transform(input[2]);
                goto case 2;
            case 2:
                target[1] = transform(input[1]);
                goto case 1;
            case 1:
                target[0] = transform(input[0]);
                break;
        }
