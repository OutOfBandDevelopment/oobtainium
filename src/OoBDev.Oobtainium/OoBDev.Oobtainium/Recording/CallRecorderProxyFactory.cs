...
public class CallRecorderProxyFactory(ICallRecorderFactory? factory = null) : ICallRecorderProxyFactory
{
    public readonly ICallRecorderFactory _factory = factory ?? new CallRecorderFactory();
