...
{
    public class CallHandlerProxyFactory : ICallHandlerProxyFactory
    {
        private readonly IServiceProvider? _serviceProvider;
        public CallHandlerProxyFactory(IServiceProvider? serviceProvider = null) => _serviceProvider = serviceProvider;

        public T Create<T>(
            ICallHandler? handler = null,
            ILogger<T>? logger = null
            ) =>
            CallHandlerProxy<T>.Create(
